      ...
      <div className="min-h-screen bg-background">
        <div className="container max-w-2xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-2xl font-bold text-foreground">Follow-up Task</h1>
          </div>
          <div className="text-center py-8">
            <p className="text-muted-foreground">Task not found or error loading task.</p>
    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-2xl mx-auto px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-foreground">Create Follow-up Task</h1>
        </div>
