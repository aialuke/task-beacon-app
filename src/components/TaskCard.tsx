      ...
      <div ref={cardRef} className={`task-card ${task.pinned ? 'border-l-4 border-l-primary' : ''} ${isExpanded ? 'expanded-card' : ''}`}>
        ...
        <div className="flex items-center w-full gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {task.description && <animated.div ref={descriptionRef} style={{
          ...
          <Button variant="ghost" size="icon" className="shrink-0 h-8 w-8" onClick={toggleExpand}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transform transition-transform ${isExpanded ? 'rotate-180' : ''}`}>
        ...
        overflow: 'hidden'
          ...
          <div className="space-y-2">
            ...
            {task.photo_url && <div>
                ...
                <img src={task.photo_url} alt="Task attachment" className="mt-1 h-20 w-20 object-cover rounded-xl" loading="lazy" />
              </div>}
