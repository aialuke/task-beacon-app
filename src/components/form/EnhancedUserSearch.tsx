      ...
      <div className="relative">
        ...
        <div className="relative">
          <UserSearchInput
            ...
            placeholder=""
            className={cn(
              "h-14 pt-6 pb-2 pl-11 pr-4 bg-background/60 backdrop-blur-sm border-border/40 rounded-2xl transition-all duration-300 focus:bg-background/80 focus:border-primary/60 focus:shadow-lg focus:shadow-primary/10 hover:bg-background/70 hover:border-border/60"
            )}
