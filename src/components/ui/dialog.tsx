...
>(({ className, children, ...props }, ref) => {
  const { keyboardVisible, viewportHeight } = useMobileViewport();
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          keyboardVisible ? "top-[20%] translate-y-0 max-h-[60vh] overflow-y-auto" : "top-[50%] translate-y-[-50%]",
          className
        )}
        style={{ 
          ...
          color: "#ffffff",
          borderColor: "#404040",
          maxHeight: keyboardVisible ? `${viewportHeight * 0.6}px` : 'auto'
        }}
        {...props}
      >
        {children}
