  ...
  'touch-ripple inline-flex touch-manipulation items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all hover:-translate-y-px hover:transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 active:translate-y-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        ...
        xl: 'h-12 rounded-full px-10 py-3',
        icon: 'size-10 rounded-full',
        'mobile-touch': 'h-12 min-w-12 rounded-full px-6 py-3',
        'mobile-compact': 'h-9 min-w-9 rounded-full px-3 py-2',
        'mobile-fab': 'size-14 rounded-full',
      },
    },
    defaultVariants: {
      variant: 'default',
