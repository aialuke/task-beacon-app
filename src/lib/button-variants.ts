...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary !bg-primary text-primary-foreground hover:bg-primary/90 rounded-full shadow hover:shadow-md",
        destructive:
        ...
        brand: "bg-primary !bg-primary text-primary-foreground rounded-full shadow hover:shadow-md",
