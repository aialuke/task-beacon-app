...
import { OptimizedTaskQueryService } from './core/task-query-optimized.service';
...
export type { OptimizedTaskQueryOptions } from './core/task-query-optimized.service';
...
export class TaskService {
  ...
  static query = OptimizedTaskQueryService;
