...
import { formatDate, truncateUrl } from '@/lib/utils/shared';
...
const arePropsEqual = (prevProps: TaskMetadataProps, nextProps: TaskMetadataProps): boolean => {
  return prevProps.dueDate === nextProps.dueDate && prevProps.url === nextProps.url;
};
function TaskMetadata({
  dueDate,
  url
}: TaskMetadataProps) {
  return <div className="flex min-w-0 flex-wrap items-center gap-4">
